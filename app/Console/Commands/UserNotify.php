...
class UserNotify extends Command
{
    ...
    public function handle()
    {
        ...
        if($invoices->count() >0 && isset($invoices)){
            ...
            $SERVER_API_KEY =
                'AAAAkVkFlwY:APA91bFIzO6B-mENxYgu8yVF3FWAuOO8rN70hcxLQgVx1Z0PiBlltlzeN8t13NWhvwFdMMlBBE3dxWlhtAKgdaDL_CKq9gQyK4oi8JGprkqgL2mNhhwwEQdHino_YxleSAE0CEobWefq';
            $data = [
