...
{{--          ----------}}
          ...
          <div class="col-12 col-md-4 d-flex">
              ...
              >
                  <div class="sa-widget-header saw-indicator__header">
                      <h2 class="sa-widget-header__title">Total Subscriptions</h2>
                      <div class="sa-widget-header__actions">

                      </div>
                  </div>
                  <div class="saw-indicator__body">
                      <div class="saw-indicator__value">{{$subscriptions}} <i class="bi bi-cart-check-fill"></i></div>
                  </div>
              </div>
          </div>
{{----------}}
          ...
          <div class="col-12 col-md-4 d-flex">
              ...
              >
                  <div class="sa-widget-header saw-indicator__header">
                      <h2 class="sa-widget-header__title">Total Blogs</h2>
                      <div class="sa-widget-header__actions">

                      </div>
                  </div>
                  <div class="saw-indicator__body">
                      <div class="saw-indicator__value">{{$blogs}} <i class="bi bi-chat-left-text-fill"></i></div>
                  </div>
              </div>
          </div>
          {{----------}}
          ...
          <div class="col-12 col-md-4 d-flex">
              ...
              >
                  <div class="sa-widget-header saw-indicator__header">
                      <h2 class="sa-widget-header__title">Total Company</h2>
                      <div class="sa-widget-header__actions">

                      </div>
                  </div>
                  <div class="saw-indicator__body">
                      <div class="saw-indicator__value">{{$company}} <i class="bi bi-building"></i></div>
                  </div>
              </div>
          </div>
          {{----------}}
          ...
          <div class="col-12 col-md-4 d-flex">
              ...
              >
                  <div class="sa-widget-header saw-indicator__header">
                      <h2 class="sa-widget-header__title">Total Services</h2>
                      <div class="sa-widget-header__actions">

                      </div>
                  </div>
                  <div class="saw-indicator__body">
                      <div class="saw-indicator__value">{{$services}} <i class="bi bi-reddit"></i></div>
                  </div>
              </div>
          </div>
          {{----------}}
          ...
          <div class="col-12 col-md-4 d-flex">
              ...
              >
                  <div class="sa-widget-header saw-indicator__header">
                      <h2 class="sa-widget-header__title">Total Portfolio</h2>
                      <div class="sa-widget-header__actions">

                      </div>
                  </div>
                  <div class="saw-indicator__body">
                      <div class="saw-indicator__value">{{$portfolio}} <i class="bi bi-person-square"></i></div>
                  </div>
              </div>
          </div>
          {{----------}}
