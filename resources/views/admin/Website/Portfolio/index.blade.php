                    ...
                    <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td><img src="{{$Portfolio->image}}" width="50px"></td>
                                <td>
                                ...
                                <td>
                                    <form method="post" action="{{url('Website/Portfolio/delete',$Portfolio->id)}}">
                                        @csrf
                                        @method("delete")
                                        @if(auth('admin')->user()->can('Portfolio-Delete'))
                                        ...
                                        @endif
                                        @if(auth('admin')->user()->can('Portfolio-Edit'))
                                        <a class="" href="{{url('Website/Portfolio/edit',$Portfolio->id)}}" title="edit">
