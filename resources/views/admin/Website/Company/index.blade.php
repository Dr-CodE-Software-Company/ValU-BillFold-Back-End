                    ...
                    <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td><img src="{{$company->image}}" width="50px"></td>
                                <td>
                                    <form method="post" action="{{url('Website/Company/delete',$company->id)}}">
                                        @csrf
                                        @method("delete")
                                        @if(auth('admin')->user()->can('Company-Delete'))
                                        ...
                                        @endif
                                        @if(auth('admin')->user()->can('Company-Edit'))
                                        <a class="" href="{{url('Website/Company/edit',$company->id)}}" title="edit">
