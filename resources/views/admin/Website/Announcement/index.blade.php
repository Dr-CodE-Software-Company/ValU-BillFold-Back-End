                    ...
                    <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td>{{$Annoncement->title}}</td>
                                <td>{{Str::limit($Annoncement->description,30)}}</td>
                                <td><img src="{{$Annoncement->image}}" width="50px"></td>
                                <td>
                                    <form method="post" action="{{url('Website/Announcement/delete',$Annoncement->id)}}">
                                        @csrf
                                        @method("delete")
                                        @if(auth('admin')->user()->can('Anoncement-Delete'))
                                        ...
                                        @endif
                                        @if(auth('admin')->user()->can('Anoncement-Edit'))
                                        <a class="" href="{{url('Website/Announcement/edit',$Annoncement->id)}}" title="edit">
